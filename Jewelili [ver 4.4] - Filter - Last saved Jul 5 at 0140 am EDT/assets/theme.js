...
$(document).ready(function() {
  ...
  if(isBespoke == 'bespoke' || isBespoke == 'bespokering'){	
    thumbnailSlider.find(".slick-slide").on("click", function(){
      var dataCount = $(this).data('slick-index');
      thumbnailSlider.find(".slick-slide").removeClass('slick-current');
      $(this).addClass('slick-current');
      gallerySlider.find(".slick-slide").removeClass('slick-current show-slide');
      gallerySlider.find(".slick-slide[data-slick-index='"+dataCount+"']").addClass('slick-current show-slide');
    });
    function productImageFilter(variantName){
      ...
      gallerySlider.find(".slick-slide").removeClass('slick-current show-slide');
      gallerySlider.find(".slick-slide:first-child").addClass('slick-current show-slide');
    }
...
$(document).ready(function() {
  ...
  $('#CustomerLoginForm form').on('submit', function(e) {
