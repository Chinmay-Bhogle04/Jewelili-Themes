  ...
  var ajaxCartDrawer = {
    ...
    AjaxcartRender: function() {
      $.get('/cart?view=mm-ajax', function(cart) {
        ...
        // free Product gift code start
        /* var FreeProductPrice = $('.cart__footer #free-gift-product200').html();
        var hasFreeProduct = false;
        
        $('.cart-popup-item-wrapper .cart-popup-item').each(function(){
          var itemVariant = $(this).data('variant-id');
          if(itemVariant == '40579271327929'){
            hasFreeProduct = true;
          }
        });*/
        
        // console.log('Free price',FreeProductPrice);
        // free Product gift code start here
        /*if(FreeProductPrice >= 19900 && !hasFreeProduct){
          data = {
            "id": 40579271327929,
            "quantity": 1
          }
