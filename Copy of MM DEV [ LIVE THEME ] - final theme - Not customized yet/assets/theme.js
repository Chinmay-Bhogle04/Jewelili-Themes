...
$(document).ready(function() {
  ...
  var homePage = {
    ...
    initCollectionProductSlider: function() {
      var collectionSlider = $('.product-slider-home .grid');
      var collectionSliderCount = parseInt($(collectionSlider).find('.grid__item').length);
      if (collectionSlider.length && collectionSliderCount > 2) {
        collectionSlider.slick({
          dots: false,
          ...
          slidesToScroll: 1,
          autoplay: false,
          prevArrow:"<button type='button' class='slick-prev pull-left'><img src='https://cdn.shopify.com/s/files/1/0252/9620/7926/files/Layer_64_1.png?v=1606045912'></button>",
          nextArrow:"<button type='button' class='slick-next pull-right'><img src='https://cdn.shopify.com/s/files/1/0252/9620/7926/files/Layer_64.png?v=1606045912'></button>",
          responsive: [
            {
              breakpoint: 800,
              settings: {
